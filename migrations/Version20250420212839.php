 ...
 */
final class Version20250420212839 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offre (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, titre VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, reduction DOUBLE PRECISION NOT NULL, dateDebut DATETIME NOT NULL, dateFin DATETIME NOT NULL, imagePath VARCHAR(255) DEFAULT NULL, INDEX IDX_AF86866F6B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, numTel VARCHAR(20) DEFAULT NULL, address LONGTEXT DEFAULT NULL, role VARCHAR(20) NOT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, nomagence VARCHAR(40) DEFAULT NULL, cin VARCHAR(40) DEFAULT NULL, typeAgence VARCHAR(50) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, reset_token VARCHAR(255) DEFAULT NULL, reset_token_expiry DATETIME DEFAULT NULL, banned DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE voyage (id INT AUTO_INCREMENT NOT NULL, id_offre INT DEFAULT NULL, id_user INT DEFAULT NULL, pointDepart VARCHAR(50) NOT NULL, dateDepart DATETIME NOT NULL, dateRetour DATETIME NOT NULL, destination VARCHAR(50) NOT NULL, nbPlacesD INT NOT NULL, type VARCHAR(50) NOT NULL, prix DOUBLE PRECISION NOT NULL, description LONGTEXT NOT NULL, titre VARCHAR(50) NOT NULL, pathImages LONGTEXT DEFAULT NULL, INDEX IDX_3F9D89554103C75F (id_offre), INDEX IDX_3F9D89556B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
